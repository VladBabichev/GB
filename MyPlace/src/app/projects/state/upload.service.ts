...
export class UploadService {
    ...
    upload(project: Project): Observable<any> {
        ...
        this.appendFormField(form, "batteryName", project.batteryName);
        this.appendFormField(form, "build", project.build);
        this.appendFormField(form, "packSupplier", project.packSupplier);
        this.appendFormField(form, "cellSupplier", project.cellSupplier);
        this.appendFormField(form, "temperature", project.temperature);
        this.appendFormField(form, "testOwner", project.testOwner);
        this.appendFormField(form, "serialNumber", project.serialNumber);
        this.appendFormField(form, "technology", project.technology);
        this.appendFormField(form, "nameplateCapacity", project.nameplateCapacity);
        this.appendFormField(form, "tester", project.tester);
        this.appendFormField(form, "procedure", project.procedure);
