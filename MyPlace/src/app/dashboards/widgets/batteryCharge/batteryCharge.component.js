...
let BatteryChargeComponent = class BatteryChargeComponent extends WidgetBase {
...
__decorate([
    Output()
], BatteryChargeComponent.prototype, "onBubleRefresh", void 0);
BatteryChargeComponent = __decorate([
    Component({
        templateUrl: "./batteryCharge.component.html",
        styleUrls: ["./batteryCharge.component.css"]
    })
], BatteryChargeComponent);
export { BatteryChargeComponent };
//# sourceMappingURL=batteryCharge.component.js.map