...
import { AggregationType, AxisRange, ShareSettings, PlotTypes } from "../model";
...
export function chartReducer(state: ChartState = initialState, action: forRoot.ChartAction): ChartState {
    switch (action.type) {
        ...
        case forRoot.SET_SHARED_USER_VIEW:
            return {
                ...state,
                sharedToken: action.sharedToken,
                plotType: PlotTypes.View
            };
        ...
        case forRoot.SET_DEFAULT_PARAMS:
            return {
                ...state,
                selectorVisible: false
            }
        ...
        case forRoot.SET_CYCLE_FILTER:
            return {
                ...
                plotParameters: {
                    ...
                    everyNthCycle: action.cycleFilter.everyNth,
                    toCycle: action.cycleFilter.to,
                    fromCycle: action.cycleFilter.from,
                    customCycleFilter: action.cycleFilter.custom,
                    threshold: action.cycleFilter.threshold,
                    minY: action.cycleFilter.minY,
                    maxY: action.cycleFilter.maxY
                },
                cycleFilter: action.cycleFilter
            };
        ...
        case forRoot.SET_UOM_SETTINGS:
            return {
                ...
                plotParameters: {
                    ...state.plotParameters,
                    currentUoM: action.uomSettings.currentUoM,
                    capacityUoM: action.uomSettings.capacityUoM,
                    timeUoM: action.uomSettings.timeUoM,
                    powerUoM: action.uomSettings.powerUoM,
                    energyUoM: action.uomSettings.energyUoM,
                    resistanceUoM: action.uomSettings.resistanceUoM,
                    normalizeBy: action.uomSettings.normalizeBy
                },
        ...
        case forRoot.END_REFRESH:
            return {
                ...
                cycleFilter: {
                    ...
                    custom: action && action.chart && action.chart.plotParameters.customCycleFilter,
        ...
        case forRoot.END_DATAPOINTS_REFRESH:
            return {
                ...
                cycleFilter: {
                    ...
                    custom: action.chart.plotParameters.customCycleFilter,
        ...
        case forRoot.SET_PLOTS_SETTINGS:
            return {
                ...state,
                plotParameters: action.plotParameters,
                chart: {
                    ...state.chart,
                    plotParameters: action.plotParameters
                },
                label: action.plotParameters.fontFamilyName ? {
                    minSpacing: 5,
                    font: {
                        family: action.plotParameters.fontFamilyName,
                        size: action.plotParameters.fontSize
                    }
                } : state.label
            }
        ...
        case forRoot.SET_STATE_OF_CHARGE:
            return {
                ...
                chart: null,
                plotTemplateId: null,
                plotType: PlotTypes.StateOfCharge,
                viewId: null,
