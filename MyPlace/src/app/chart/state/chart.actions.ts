...
import { AggregationSettings, AxisRange, StateOfCharge, PlotTemplate, PlotsData, Chart, ChartFilter, ChartUoMSettings, ChartSettings, Series, PlotParameters } from "../model";
...
export const SET_SHARED_USER_VIEW = "CHART: SET_SHARED_USER_VIEW";
export const CREATE_TEMPLATE_FROM_CHART = "CHART: CREATE_TEMPLATE_FROM_CHART";
export const CREATE_TEMPLATE_FROM_CHART_DIALOG_OPEN = "CHART: CREATE_TEMPLATE_FROM_CHART_DIALOG_OPEN";
export const CREATE_TEMPLATE_FROM_CHART_CONFIRM_DIALOG_OPEN = "CHART: CREATE_TEMPLATE_FROM_CHART_CONFIRM_DIALOG_OPEN";

export const DELETE_PROJECTS = "CHART: DELETE_PROJECTS";
...
export class SetPlotSettings implements Action {
    readonly type = SET_PLOTS_SETTINGS;

    constructor(public plotParameters: PlotParameters) {
    }
}
...
export class SetUserSharedView implements Action {
    readonly type = SET_SHARED_USER_VIEW;
    constructor(public sharedToken: string) {
    }
}

export class CreateTemplateFromChart implements Action {
    readonly type = CREATE_TEMPLATE_FROM_CHART;

    constructor(public templateName: string) {
    }
}

export class CreateTemplateFromChartDialogOpen implements Action {
    readonly type = CREATE_TEMPLATE_FROM_CHART_DIALOG_OPEN;
}

export class CreateTemplateFromChartConfirmDialogOpen implements Action {
    readonly type = CREATE_TEMPLATE_FROM_CHART_CONFIRM_DIALOG_OPEN;
...
export class DeleteProjects implements Action {
    ...
    constructor(public objectIds: number[]) {
    }
}
...
export type ChartAction
    ...
    | SetUserSharedView
    | SetPlotSettings
    | CreateTemplateFromChartDialogOpen
    | CreateTemplateFromChartConfirmDialogOpen
