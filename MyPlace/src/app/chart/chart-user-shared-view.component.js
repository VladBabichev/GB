...
let ChartUserSharedViewComponent = class ChartUserSharedViewComponent {
...
], ChartUserSharedViewComponent.prototype, "appChartComponent", void 0);
__decorate([
    Input()
], ChartUserSharedViewComponent.prototype, "displaySystemPlotSelector", void 0);
__decorate([
    Input()
], ChartUserSharedViewComponent.prototype, "displayCustomTemplates", void 0);
__decorate([
    Output()
], ChartUserSharedViewComponent.prototype, "close", void 0);
ChartUserSharedViewComponent = __decorate([
    Component({
        selector: "app-chart-user-shared-view",
        templateUrl: "./chart-user-shared-view.component.html",
        styleUrls: ["./chart-user-shared-view.component.css"]
    })
], ChartUserSharedViewComponent);
export { ChartUserSharedViewComponent };
//# sourceMappingURL=chart-user-shared-view.component.js.map